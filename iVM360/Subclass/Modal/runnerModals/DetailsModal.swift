...
//  iVM360
//
//  Created by 1707 on 31/01/25.
//

import Foundation
class DetailsModal: Codable {
    var tripId: Int
    var userId: Int
    var tripTypeId: Int
    ...
    convenience init(withData data: [String: Any]) {
        ...
        self.startLatitude = data["startLatitude"] as? String
        self.startLongitude = data["startLongitude"] as? String
        self.endLatitude = data["endLatitude"] as? String
        self.endLongitude = data["endLongitude"] as? String
