...
//MARK: - Show Popup
    func show(complete : ((Int)->())? , view: UIView,animationType: NSString,strMessage: String,btnArray: NSArray,strTitle: String = "")
    {
        ...
        for strBtnTitle in btnArray
        {
            ...
            btnOk.backgroundColor = UIColor(red: 0.0/255.0, green: 137.0/255.0, blue: 120.0/255.0, alpha: 1)
            ...
            btnOk.tag = counter
                ...
                if counter == 1{
                    btnOk.backgroundColor = UIColor(red: 245/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1)
                }else{
                    btnOk.backgroundColor = UIColor(red: 0.0/255.0, green: 137.0/255.0, blue: 120.0/255.0, alpha: 1)
                }
